...
public class DayCycleHandler {
    ...
    public void onServerTick(TickEvent.LevelTickEvent event) {
        ...
        // vanilla adds +1/tick for 12000 game ticks per half-day
        // we want to take dayRealTicks/nightRealTicks real ticks instead
        double targetRate = isDay
            ? (12000.0 / dayRealTicks)
            : (12000.0 / nightRealTicks);
        double delta = targetRate - 1.0; // vanilla already added 1
        ...
        if (toAdd != 0) {
            ...
            if (newTime < 0) newTime += VANILLA_CYCLE;
